        ...
        if ("data" in error) {
          ...
          if (errorData) {
            if (errorData && (errorData as any)?.errors) {
              ...
              if ((errorData as any)?.errors?.password_confirmation) {
                toast.error(
                  (errorData as any)?.errors?.password_confirmation[0]
                );
              }
              if ((errorData as any)?.errors?.password) {
                toast.error((errorData as any)?.errors?.password[0]);
              }
              if ((errorData as any)?.errors?.password_reset_token) {
                toast.error(
                  (errorData as any)?.errors?.password_reset_token[0]
                );
              }
            } else {
